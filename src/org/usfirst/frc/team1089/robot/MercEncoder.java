...
public class MercEncoder {
	public final static double WHEEL_SIZE_INCHES = 10.0;
	public final static double TICKS_PER_ROTATION = 1440;
	public final static double GEAR_RATIO = 4.0/3.0; // TODO FIX THIS (on new robot should be a number above 1.0)
