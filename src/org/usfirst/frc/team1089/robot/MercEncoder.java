...
public class MercEncoder {
	...
	public final static double GEAR_RATIO = 1.0; // TODO FIX THIS (on new robot should be a number between 0.0 and 1.0)
	public final static double DISTANCE_PER_TICK_INCHES = (WHEEL_SIZE_INCHES * GEAR_RATIO * Math.PI / TICKS_PER_ROTATION);
