...
/**
 * The {@code MercLogger} class contains code to collect different kinds of data and store them in a document on the roborio
 */
public class MercLogger {
	
	private static MercLogger _currentLogger = null; //Initialized by getCurrent() if necessary
	 ...
	 * </pre>
	 * Gets the current {@code MercLogger} being used by the robot.
	 * @return the current {@code MercLogger} being used by the robot.
	 */
	public synchronized static MercLogger getCurrent() {
	...
	/**
	 * <pre>
	 * public synchronized static void MercLogger debug()
	 * </pre>
